...
<h4>
  <a href="{{ site.baseurl }}/PI/#{{ member.slug }}" style="text-decoration:none;color:inherit;">
    {{ member.name }}
  </a>
</h4>
<i>{{ member.info }}</i><br>
  ...
  {% if member.google_scholar %} <a href="{{ member.google_scholar }}" target="_blank"><i class="ai ai-google-scholar-square ai-2x"></i></a> {% endif %}
...
<div class="col-sm-4 col-xs-12">
  <h4>{{ member.name }}</h4>
  <i>{{ member.medical_specialty }} <br>{{ member.info }}</i>
  <ul style="overflow: hidden">
  </ul>
</div>
